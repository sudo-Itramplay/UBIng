...
>[!NOTE] Breu
>És el [[Uni/3rAny/Subjects/Q1/TNUI/ThTNUI/PPT1i2/Descens del gradient]] agafant una dada aleatoria cada cop.
...
2. **Càlcul del Gradient Estocàstic:**
    ...
    - Calcula el **[[Uni/3rAny/Subjects/Q1/TNUI/ThTNUI/PPT1i2/Gradient|gradient]] ∇Ei​(θ)** de la funció de cost utilitzant **només** la dada (o _mini-batch_) seleccionada.
...
- **Batch GD** - [[Uni/3rAny/Subjects/Q1/TNUI/ThTNUI/PPT1i2/Descens del gradient]]
