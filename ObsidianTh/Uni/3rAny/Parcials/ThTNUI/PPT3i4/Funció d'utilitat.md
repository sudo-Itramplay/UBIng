...
- $C$ [[Uni/3rAny/Parcials/ThTNUI/PPT3i4/Conjunt de tots els usuaris]]
- $S$ [[Uni/3rAny/Parcials/ThTNUI/PPT3i4/Conjunt de tots els items recomanables]]
...
$u$ assigna el grau d'utilitat o interes que té un determinat item per una determinada persona
 ...
 >hem d'[[Uni/3rAny/Parcials/ThTNUI/PPT3i4/Inferir|inferir]] en els seus valors
 
En la Pràctica es sol retornar una llista ordenada dels elements seleccionants segons $u(c,s)$

>[!Danger] hem d'anar amb compte
>Les [[Uni/3rAny/Parcials/ThTNUI/PPT3i4/Inferir|inferencies]] es poden fer de diverses maneres
