...
L'**[[Smoothing|allisament]]** és una tècnica de filtratge utilitzada per reduir el soroll en una imatge. Existeixen diferents **[[Uni/3rAny/Subjects/Q1/Visio/TH/ppt2 i 3/Filtres Lineals/Processament amb filtres/Filtres/Tipus de soroll|tipus de soroll]]**, i cada un es tracta de manera més efectiva amb filtres específics.
