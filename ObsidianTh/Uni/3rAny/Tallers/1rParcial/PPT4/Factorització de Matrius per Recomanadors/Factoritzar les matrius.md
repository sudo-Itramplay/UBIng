...
Aquestes noves matrius representen **factors latents** ([[Uni/3rAny/Tallers/1rParcial/PPT4/Factorització de Matrius per Recomanadors/Features]])(característiques ocultes o abstractes) que expliquen per què un usuari ha donat una certa valoració a un ítem.
...
## Com funciona?
Per calcular la valoració predita, haurem de fer el càlcul d'una de les [[Uni/3rAny/Tallers/1rParcial/PPT4/Factorització de Matrius per Recomanadors/Features]]

## [[Uni/3rAny/Tallers/1rParcial/PPT4/Factorització de Matrius per Recomanadors/Com Factoritzar Matrius?]]