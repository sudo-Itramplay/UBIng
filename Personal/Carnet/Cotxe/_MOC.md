# Carnet de Conducir B — Apuntes

## Resumen Central: Errores de los Tests

Este documento es el **RESUMEN CENTRAL**. Aquí se muestran, de manera resumida, los errores cometidos en los tests, ordenados por categorías. Cada punto remite al apunte atómico correspondiente.
...
- **Corrección:** Los números romanos indican los días: I = impares, II = pares, 1-15 = primera quincena. Sin número = todos los días.
- → Ver: [[Senal-Estacionamiento-Prohibido-R308]]

### 51. Pérdida máxima de puntos en un día
- **Error:** No se sabía el límite de puntos que se pueden perder en un día.
- **Corrección:** Máximo 8 puntos por día, excepto si las infracciones conllevan pérdida total del permiso (reincidencia, condiciones extremas).
- → Ver: [[Perdida-Maxima-Puntos]]

### 52. Luces antiniebla — Vías estrechas y otros usos
- **Error:** No se sabía que las antiniebla se pueden usar en vías estrechas con curvas.
- **Corrección:** Sí, en vías estrechas (≤ 6,5 m) con curvas sucesivas señalizadas. También en niebla espesa, lluvia muy intensa, fuerte nevada, polvo/humo denso.
- → Ver: [[Luces-Antiniebla-Cuando-Usar]]

### 53. Señal STOP — Detención obligatoria
- **Error:** Descripción imprecisa (círculo rojo con línea negra).
- **Corrección:** La señal R-2 (STOP) es octogonal, roja, y obliga a **detenerse completamente** (0 km/h) antes de la línea de detención y ceder el paso. Multa de 200 € + 4 puntos.
- → Ver: [[Senal-STOP-Detencion-Obligatoria]]

### 54. R-302 — Prohibición de cambiar el sentido (no prohibe girar izquierda)
- **Error:** Se creía que la R-302 prohibe girar a la izquierda.
- **Corrección:** La R-302 solo prohibe el cambio de sentido (U-turn). Girar a la izquierda lo prohibe la R-303.
- → Ver: [[R-302-Prohibicion-Cambiar-Sentido]]

### 55. Carril sentido contrario por obras — Vehículos permitidos
- **Error:** Se creía que solo podían circular turismos y motos.
- **Corrección:** Por obras (señalización amarilla) pueden circular TODOS los vehículos autorizados en la vía.
- → Ver: [[Carril-Sentido-Contrario-Obras]]

### 56. Facilitar incorporación con prioridad
- **Error:** Se creía que al tener prioridad no hay que facilitar la incorporación.
- **Corrección:** Aunque tengas prioridad, debes facilitar la incorporación siempre que sea posible.
- → Ver: [[Facilitar-Incorporacion-Prioridad]]

### 57. Láminas adhesivas en ventanillas traseras
- **Error:** Se creía que nunca se podían poner láminas.
- **Corrección:** Sí, en ventanillas posteriores, pero solo si el vehículo lleva dos espejos retrovisores exteriores.
- → Ver: [[Laminas-Adhesivas-Ventanillas-Posteriores]]

### 58. Velocidad turismo + remolque ligero en autovía
- **Error:** Se creía que era 80 km/h u otra velocidad.
- **Corrección:** En autovía/autopista, turismo + remolque ≤750 kg = **90 km/h**.
- → Ver: [[Velocidad-Turismo-Remolque-Autovia]]

### 59. Carril adicional circunstancial — Velocidad
- **Error:** Se desconocía la velocidad máxima.
- **Corrección:** Carril adicional en arcenes: velocidad máxima **80 km/h**, mínima **60 km/h**.
- → Ver: [[Carril-Adicional-Circunstancial]]

### 60. Avería en túnel — Abandonar el vehículo
- **Error:** Se creía que había que esperar dentro del vehículo.
- **Corrección:** Hay que abandonar el vehículo y dirigirse al refugio o salida más próximos.
- → Ver: [[Averia-Tunel-Abandonar-Vehiculo]]

### 61. Cambio dirección izquierda en doble sentido
- **Error:** Se creía que había que colocarse en el borde izquierdo.
- **Corrección:** En doble sentido, hay que ceñirse a la marca longitudinal que separa ambos sentidos.
- → Ver: [[Cambio-Direccion-Izquierda-Doble-Sentido]]

### 62. Panel complementario — Distancia de prohibición
- **Error:** Se creía que indicaba la distancia hasta la señal.
- **Corrección:** Indica la distancia en que se aplica la prohibición en el sentido de la flecha.
- → Ver: [[Panel-Complementario-Distancia-Prohibicion]]

### 63. Carril sentido contrario por fluidez — Vehículos permitidos
- **Error:** Se creía que podían circular todos los vehículos (como por obras).
