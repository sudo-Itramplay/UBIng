...
2. Sinó: estimació construida a partir de les utilitat $u(c_i,s)$ 
	Es a dir, determinarem u(s) per $c_1$ (a qui li volem recomanar) segons la seva [[Uni/3rAny/Subjects/Q1/TNUI/ThTNUI/PPT3i4/Semblança en Recomanadors|semblança]] amb persona $c_i$ 
...
$$
donada la matriu de la [[Uni/3rAny/Subjects/Q1/TNUI/ThTNUI/PPT3i4/Funció d'utilitat]]
>$$
\mathbf{U} = 
\begin{pmatrix}
? & \cdots & u_{1p} & \cdots & ? && \\
